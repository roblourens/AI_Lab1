...
{
    static LinkedList<SearchNode> OPEN; // Feel free to choose your own data structures for
                                        // searching,
    ...
    static void performSearch(String startNode, String directoryName,
    ...
    static void addNewChildrenToOPEN(SearchNode parent, String contents,
            String searchStrategy)
    {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (token.equalsIgnoreCase("<A")) {
                ...
                if (OPEN.contains(hyperlink)) { // If already in OPEN, we'll ignore this hyperlink
                                                // (Be sure to read the "Technical Note" below.)
                    if (DEBUGGING)
                        System.out.println(" - this node is in the OPEN list.");
                } else if (CLOSED.contains(hyperlink)) { // If already in CLOSED, we'll also ignore
                                                         // this hyperlink.
                    if (DEBUGGING)
                        System.out
                                .println(" - this node is in the CLOSED list.");
                } else { // Collect the hypertext if this is a previously unvisited node.
